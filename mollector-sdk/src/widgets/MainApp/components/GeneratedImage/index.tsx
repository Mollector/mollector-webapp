...
// Frame image
const frameBackImg = 'https://api-dev.mollector.com/static/card/Frame_Back.png'
const frameBottomImg = 'https://api-dev.mollector.com/static/card/Frame_Bottom.png'
const frameEliteImg = 'https://api-dev.mollector.com/static/card/Frame_Elite.png'
const frameInnerImg = 'https://api-dev.mollector.com/static/card/Frame_Inner.png'
// Star Icon
const StarOffIcon = 'https://api-dev.mollector.com/static/card/Star_Off.png'
const StarOnIcon = 'https://api-dev.mollector.com/static/card/Star_On.png'
// Attack Icon
const AttackMeleeIcon = 'https://api-dev.mollector.com/static/card/stat_Attack_Melee.png'
const AttackRangeIcon = 'https://api-dev.mollector.com/static/card/stat_Attack_Range.png'
const HpIcon = 'https://api-dev.mollector.com/static/card/stat_HP.png'
